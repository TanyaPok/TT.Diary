...
namespace TT.Diary.WebAPI.Controllers.Lists.Appointments
{
    ...
    {
        public AppointmentController(ILogger<AppointmentController> logger, IMediator mediator) : base(logger, mediator)
        {
        }
        ...
        public async Task<ActionResult<ToDo<ScheduleSettingsSummary>>> Get(int id)
        {
            ...
            {
                return BadRequest(string.Format(CLIENT_ERROR_MESSAGE, ErrorMessages.GetAppointment.GetDescription(),
                    ex.Message));
            }
        }
        ...
        public async Task<ActionResult<int>> RemoveAsync(int id)
        {
            ...
            {
                return BadRequest(string.Format(CLIENT_ERROR_MESSAGE, ErrorMessages.RemoveAppointment.GetDescription(),
                    ex.Message));
            }
        }
        ...
        public async Task<ActionResult<int>> EditAsync([FromBody] EditCommand query)
        {
            ...
            {
                return BadRequest(string.Format(CLIENT_ERROR_MESSAGE, ErrorMessages.SaveAppointment.GetDescription(),
                    ex.Message));
            }
        }
