...
{
    public class UnscheduledHabitsController : ApiControllerBase
    {
        public UnscheduledHabitsController(ILogger<UnscheduledHabitsController> logger, IMediator mediator) : base(logger, mediator)
        {
        }
