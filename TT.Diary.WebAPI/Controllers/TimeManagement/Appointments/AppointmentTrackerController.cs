...
{
    public class AppointmentTrackerController  : ApiControllerBase
    {
        public AppointmentTrackerController(ILogger<AppointmentTrackerController> logger, IMediator mediator) : base(logger,
            mediator)
        {
        }
