...
using TT.Diary.BusinessLogic.TimeManagement.AppointmentSchedule.Commands;

namespace TT.Diary.WebAPI.Controllers.TimeManagement.Appointments
{
    public class AppointmentScheduleController : ApiControllerBase
    {
        public AppointmentScheduleController(ILogger<AppointmentScheduleController> logger, IMediator mediator) : base(logger,
            mediator)
        {
        }
