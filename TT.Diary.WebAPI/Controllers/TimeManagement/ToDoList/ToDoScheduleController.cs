...
using TT.Diary.BusinessLogic.TimeManagement.ToDoSchedule.Commands;

namespace TT.Diary.WebAPI.Controllers.TimeManagement.ToDoList
{
    public class ToDoScheduleController : ApiControllerBase
    {
        public ToDoScheduleController(ILogger<ToDoScheduleController> logger, IMediator mediator) : base(logger,
            mediator)
        {
        }
