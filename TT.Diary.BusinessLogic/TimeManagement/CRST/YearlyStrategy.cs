...
{
    internal class YearlyStrategy : CRSTStrategy
    {
        ...
        private DateTime GetNextDate(DataAccessLogic.Model.TimeManagement.Months months, uint every, int startDay, DateTime date)
        {
